...
features_list = []
features_list.append(mlc_configurator.mlc_feature("MEAN", "Acc_X"))
features_list.append(mlc_configurator.mlc_feature("MEAN", "Acc_Y"))
features_list.append(mlc_configurator.mlc_feature("MEAN", "Acc_Z"))
